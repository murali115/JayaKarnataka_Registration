...
@interface MembersViewController_iPad ()

@end

@implementation MembersViewController_iPad
...
-(void) checkOrientation{
    ...
    if (UIInterfaceOrientationIsLandscape(self.interfaceOrientation)) {
        _buttonAll.frame = CGRectMake(0, 0, 205, 60);
        _buttonDay.frame = CGRectMake(205, 0, 205, 60);
        _buttonWeek.frame = CGRectMake(410, 0, 205, 60);
        _buttonMonth.frame = CGRectMake(615, 0, 205, 60);
        _buttonYear.frame = CGRectMake(820, 0, 205, 60);
        
        _tabBar.frame = CGRectMake(0, 0+deltaY, 1024, 60);
        
        view.frame = CGRectMake(0, 47+deltaY, 1024, 5);
        
        _tableMembers.frame = CGRectMake(0, 108+deltaY, 1024, 660-deltaY);
        _searchBar.frame = CGRectMake(0, 64 +deltaY,1024,44);
        
        
        _weekPicker.frame = CGRectMake(0, 487+deltaY, 1024, 216);
        _monthPicker.frame = CGRectMake(0, 487+deltaY, 1024, 216);
        _yearPicker.frame = CGRectMake(0, 487+deltaY, 1024, 216);
        _dayPicker.frame = CGRectMake(0, 487+deltaY, 1024, 216);
        
        myToolBar.frame = CGRectMake(0, 447+deltaY, 1024, 40);

        _indicatorview.frame = self.view.frame;
        
    }
    else{
        _buttonAll.frame = CGRectMake(0, 0, 153, 60);
        _buttonDay.frame = CGRectMake(153, 0, 153, 60);
        _buttonWeek.frame = CGRectMake(308, 0, 153, 60);
        _buttonMonth.frame = CGRectMake(461, 0, 153, 60);
        _buttonYear.frame = CGRectMake(614, 0, 153, 60);
        
        _tabBar.frame = CGRectMake(0, 0+deltaY, 768, 60);
        
        view.frame = CGRectMake(0, 47+deltaY, 768, 5);
        
        _tableMembers.frame = CGRectMake(0, 108+deltaY, 768, 916-deltaY);
        _searchBar.frame = CGRectMake(0, 64 +deltaY,768,44);
        
        _weekPicker.frame = CGRectMake(0, 743+deltaY, 768, 216);
        _monthPicker.frame = CGRectMake(0, 743+deltaY, 768, 216);
        _yearPicker.frame = CGRectMake(0, 743+deltaY, 768, 216);
        _dayPicker.frame = CGRectMake(0, 743+deltaY, 768, 216);
        
        myToolBar.frame = CGRectMake(0, 703+deltaY, 768, 40);
...
- (void)viewDidLoad
{
    ...
    _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 64 +deltaY,768,44)];
    ...
    view = [[UIView alloc] initWithFrame:CGRectMake(0, 47+deltaY, 768, 5)];
    ...
    [self initPickers];
    _dayPicker = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 719+deltaY, 768, 240)];
    _dayPicker.datePickerMode = UIDatePickerModeDate;
    
    
    myToolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 704+deltaY, 768, 40)];
    ...
    _tabBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0+deltaY, 768, 60)];
    [self.view addSubview:_tabBar];
    _tabBar.backgroundColor = [UIColor whiteColor];
    //    _tabBar.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
    
    _buttonAll = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 153, 60)];
    ...
    _buttonDay = [[UIButton alloc] initWithFrame:CGRectMake(153, 0, 153, 60)];
    ...
    _buttonWeek = [[UIButton alloc] initWithFrame:CGRectMake(308, 0, 153, 60)];
    ...
    _buttonMonth = [[UIButton alloc] initWithFrame:CGRectMake(461, 0, 153, 60)];
    ...
    _buttonYear = [[UIButton alloc] initWithFrame:CGRectMake(614, 0, 153, 60)];
...
//    [self.view addSubview:_scrollView];
    ...
    _scrollView.contentSize = CGSizeMake(self.view.frame.size.width * n, self.view.frame.size.height-40);
...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    if (toInterfaceOrientation == UIInterfaceOrientationLandscapeLeft || toInterfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        ...
        _tableMembers.frame = CGRectMake(0, 108+deltaY, 768, 918-deltaY);
...
//    bkp = selectedTable;
    ...
    [GetData getDataFromUrl:[NSString stringWithFormat:@"http://www.youflik.cc/jkapi/public/index.php/Api/v1/user?created_by=%@&search_text=%@",_user_id, _searchBar.text] withParameters:nil withHeader:_token WithCompletion:^(NSMutableArray *array) {
...
//    _searchBar.frame = CGRectMake(0, 64 +deltaY,768,60);
}
...
-(void) createTable{
    ...
    if (_tableMembers == nil) {
        _tableMembers = [[UITableView alloc] initWithFrame:CGRectMake(0, 108+deltaY, 768, 1024-108-deltaY)];
        ...
        _tableMembers = [[UITableView alloc] initWithFrame:CGRectMake(0, 108+deltaY, 768, 1024-40-deltaY)];
        _tableMembers.dataSource = self;
        _tableMembers.delegate = self;
        [self.view addSubview:_tableMembers];
        _labelStatus.hidden = YES;
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CustomTableViewCell_iPad *cell =(CustomTableViewCell_iPad *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier] ;
    if (cell == nil) {
        cell = [[CustomTableViewCell_iPad alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
    ...
    cell.imageViewProfilePic.layer.cornerRadius = 30.0f;
    cell.imageViewProfilePic.clipsToBounds = YES;
    
    [cell.myView addSubview:cell.imageViewProfilePic];
    
    cell.labelName.font = [UIFont systemFontOfSize:24];
    cell.labelName.text = [_user valueForKey:@"firstname"];
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.searchDisplayCon.searchResultsTableView && self.searchDisplayCon.searchResultsTableView.hidden == NO) {
        _profileViewController = [[ProfileViewController_iPad alloc] init];
...
-(void) initPickers{
    ...
    _weekPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 719+deltaY, 768, 240)];
    _weekPicker.tag = 0;
    ...
    _monthPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 719+deltaY, 768, 240)];
    _monthPicker.tag = 1;
    ...
    _yearPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 719+deltaY, 768, 240)];
    _yearPicker.tag = 2;
