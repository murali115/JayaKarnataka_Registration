//
//  RegistrationViewController_iPad.m
//  Registration_Mock
//
...
@interface RegistrationViewController_iPad ()
...
@implementation RegistrationViewController_iPad
...
-(void) checkOrientation{
    ...
    if (UIInterfaceOrientationIsLandscape(self.interfaceOrientation)) {
        ...
        {
            statusView.frame = CGRectMake(20, 25, 984, 40);
            ...
            imageView.frame = CGRectMake(190, 630, 100, 100);
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        {
            statusView.frame = CGRectMake(20, 25, 728, 40);
        ...
        [UIView animateWithDuration:1 animations:^
         {
             ...
             statusView.frame = CGRectMake(20, 25+_deltaY, 728, 40);
         }
    ...
    [UIView animateWithDuration:1 animations:^
     {
         if (UIInterfaceOrientationIsLandscape(self.interfaceOrientation))
         {
             statusView.frame = CGRectMake(20, 0+_deltaY, 984, 40);
             statusView.alpha = 1.0f;
         }
         else{
             statusView.frame = CGRectMake(20, 0+_deltaY, 728, 40);
             statusView.alpha = 1.0f;
         }
     }
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex == 0) {
        _membersViewController = [[MembersViewController_iPad alloc] init];
